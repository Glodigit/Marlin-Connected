...
#define MIXING_EXTRUDER
  ...
  #define PUSH_PULL_TOOLCHANGE   // Simultaneously push the new V-tool and pull the old V-tool into the melt chamber
    ...
    #define MIXING_PUSH_PULL_MM         1.8  // (mm)     Maximum length for a single extruder to push/pull
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 480, 480, 120, 120 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4800, 4800, 300, 4800 }
