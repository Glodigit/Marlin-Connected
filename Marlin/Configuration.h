...
#define CUSTOM_MACHINE_NAME "CR600S"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
// CR600S
#define MACHINE_UUID "e9c1f5f0-2b49-485c-963c-961354273419"
// Linear Plus
//#define MACHINE_UUID "a2de76e5-9426-45c2-88d2-4df117b59c03"
// Flash
//#define MACHINE_UUID "d35c1c6b-a545-4f4e-a91c-c94f4a447c7b"
// DP2W
//#define MACHINE_UUID "96c12c46-7741-4034-81ba-571582481f0d"
// DP2B
//#define MACHINE_UUID "e65ebb17-7c05-4f09-960a-152683edecb7"
// SecSavr Skyrise
//#define MACHINE_UUID "0fc05c4a-91d0-4483-97d4-7e728b3d01ca"
...
#define DIAG_JUMPERS_REMOVED      // Sensorless homing via BTT EXP MOT
...
#define MIXING_EXTRUDER
  ...
  #define PUSH_PULL_TOOLCHANGE     // Simultaneously push the new V-tool and pull the old V-tool into the melt chamber
    ...
    #define MIXING_PUSH_PULL_MM         2.4  // (mm)     Maximum length for a single extruder to push/pull
    #define MIXING_PUSH_PULL_FEEDRATE   120  // (mm/min) V-tool extruder feedrate
  #endif
#endif
 ...
 */
//#define PSU_CONTROL
#define PSU_NAME "Bed Electromechanical Relay"
...
#define CHAMBER_MAXTEMP  248  // Using "chamber" for coaxial8or heater
 ...
 */
  ...
  #define MPC_HEATER_POWER { 60.0f }                  // (W) Heat cartridge powers.

  #define MPC_INCLUDE_FAN                             // Model the fan speed?

  // Measured physical constants from M306
  // CHC Pro connected to Coaxial8or
  #define MPC_BLOCK_HEAT_CAPACITY         { 9.5503f } // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS       { 0.6795f } // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF          { 0.2119f } // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.2064f } // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4800, 4800, 90, 4800 }
...
// Includes a 1.5mm margin around the edges
...
#define HOMING_FEEDRATE_MM_M { (75*60), (75*60), (30*60) }
